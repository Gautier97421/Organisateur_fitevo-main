  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Votre compte est configuré. Vous pouvez maintenant vous connecter.',
      })
      router.push('/')
    } catch (err: any) {
...
export default function FirstLoginPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-gradient-to-br from-red-600 via-black to-red-800 flex items-center justify-center">
