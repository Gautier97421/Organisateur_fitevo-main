...
export default function CreatePasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Charger les données complètes de l'employé
          ...
          *,
          employee_gyms (
            ...
            gyms (
              id,
              name,
              default_network:allowed_networks (
                network_name,
                network_ssid
              )
            )
      ...
      // Supprimer l'utilisateur temporaire et créer la session
      ...
      localStorage.setItem(
        ...
        JSON.stringify({
          ...
          type: "employee",
          remote_work_enabled: employeeData.remote_work_enabled,
          gyms: employeeData.employee_gyms?.map((eg: any) => eg.gyms) || [],
        }),
      )
            ...
            <div className="space-y-2 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="space-y-1">
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <span
                    className={
                      password.length >= 6 ? "text-green-700 dark:text-green-400" : "text-red-700 dark:text-red-400"
                    }
                  >
                ...
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <span
                    className={
                      /\d/.test(password) ? "text-green-700 dark:text-green-400" : "text-red-700 dark:text-red-400"
                    }
                  >
                    Au moins un chiffre
                  </span>
